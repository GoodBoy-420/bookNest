  ...
  return (
    <div className="col-span-full flex justify-center">
      <div className="flex items-center justify-between w-full max-w-80 text-gray-500 font-medium">
        ...
        >
          <img src={Left} alt="Left Arrow" className="w-5 hover:text-xl" />
        </button>
        ...
        <div className="flex items-center gap-2 text-sm font-medium">
          {[...Array(totalPages)].map((_, i) => (
            <button
              ...
              className="h-10 w-10 flex items-center justify-center aspect-square hover:text-xl"
              // {page === i + 1 ? "font-bold" : ""}
            >
              {i + 1}
            </button>
        ...
        <button
          ...
          className="rounded-full bg-slate-200/50 "
        >
          <img src={Right} alt="Right Arrow" className="w-5 hover:text-xl" />
        </button>
      </div>
    </div>
  );
